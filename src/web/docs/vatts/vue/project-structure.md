...
This approach is simple and keeps routes colocated with your pages.
...
This file is imported in `layout.vue` and typically includes resets, typography, color variables, and base styles.
